...
class UserDataStream extends Stream{
    ...
    async restart(ping_interval){
        this.listenKey = (await this._rest.startUserDataStream()).listenKey;
        ...
        this.once('close', () => {
            ...
            // uncomment to not reuse listenKey on restart
            //this._rest.closeUserDataStream({listenKey: this.listenKey});
        });
