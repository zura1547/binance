    ...
    describe('public API', () => {
        ...
        it('should make time requests and handle the response', () => {
            mockRequest.setHandler('api/v1/time', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"serverTime":1503209580315}');
            });
            return binance.time()
                .then((response) => {
        ...
        it('should make allPrices requests and handle the response', () => {
            mockRequest.setHandler('api/v1/ticker/allPrices', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"symbol":"ETHBTC","price":"0.04032100"},{"symbol":"LTCBTC","price":"0.00886500"},{"symbol":"BNBBTC","price":"0.00021682"},{"symbol":"NEOBTC","price":"0.00367100"},{"symbol":"123456","price":"0.00030000"},{"symbol":"QTUMETH","price":"0.02884900"},{"symbol":"EOSETH","price":"0.00852300"},{"symbol":"SNTETH","price":"0.00016834"},{"symbol":"BNTETH","price":"0.00565300"},{"symbol":"BCCBTC","price":"0.13200000"},{"symbol":"GASBTC","price":"0.00187000"},{"symbol":"BNBETH","price":"0.00537000"}]');
            });
        ...
        it('should make depth requests and handle the response', () => {
            mockRequest.setHandler('api/v1/depth', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"lastUpdateId":2727677,"bids":[["0.07085000","11.09700000",[]],["0.07080300","5.70500000",[]],["0.07070000","5.00000000",[]],["0.07067500","6.95000000",[]],["0.07065100","1.10100000",[]]],"asks":[["0.07096700","1.40300000",[]],["0.07118300","0.92900000",[]],["0.07119300","3.60300000",[]],["0.07125700","0.24900000",[]],["0.07129600","2.00000000",[]]]}');
            });
        ...
        it('should make trades requests and handle the response', () => {
            mockRequest.setHandler('api/v1/trades', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"id":17843116,"price":"0.07625700","qty":"0.08700000","time":1515439245305,"isBuyerMaker":false,"isBestMatch":true},{"id":17843117,"price":"0.07625700","qty":"0.13600000","time":1515439245318,"isBuyerMaker":false,"isBestMatch":true},{"id":17843118,"price":"0.07614300","qty":"0.43200000","time":1515439245553,"isBuyerMaker":false,"isBestMatch":true}]');
            });
        ...
        it('should make historical trades requests and handle the response', () => {
            mockRequest.setHandler('api/v1/historicalTrades', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"id":17851860,"price":"0.07600400","qty":"0.11000000","time":1515440470089,"isBuyerMaker":true,"isBestMatch":true},{"id":17851861,"price":"0.07607700","qty":"0.06600000","time":1515440470158,"isBuyerMaker":false,"isBestMatch":true},{"id":17851862,"price":"0.07607700","qty":"0.32400000","time":1515440470158,"isBuyerMaker":false,"isBestMatch":true}]');
            });
        ...
        it('should make kline requests and handle the response', () => {
            mockRequest.setHandler('api/v1/klines', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[[1503213420000,"0.07120000","0.07132100","0.07120000","0.07130300","3.94900000",1503213479999,"0.28160693",6,"3.50900000","0.25026338","56742.16444446"],[1503213480000,"0.07130300","0.07137300","0.07120000","0.07137300","13.59200000",1503213539999,"0.96808274",15,"2.52600000","0.18018091","56676.42790975"],[1503213540000,"0.07137300","0.07159900","0.07127600","0.07136700","9.18600000",1503213599999,"0.65519433",21,"8.40100000","0.59919476","56659.02528193"],[1503213600000,"0.07127600","0.07142000","0.07127600","0.07132100","11.13600000",1503213659999,"0.79448882",14,"1.59700000","0.11399855","56672.51428193"],[1503213660000,"0.07132100","0.07132100","0.07132100","0.07132100","0.00000000",1503213719999,"0.00000000",0,"0.00000000","0.00000000","56672.51428193"]]');
            });
        ...
        it('should make 24 hour ticker requests and handle the response', () => {
            mockRequest.setHandler('api/v1/ticker/24hr', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"priceChange":"-0.00116100","priceChangePercent":"-1.614","weightedAvgPrice":"0.07098817","prevClosePrice":"0.07191900","lastPrice":"0.07075800","bidPrice":"0.07075800","askPrice":"0.07077200","openPrice":"0.07191900","highPrice":"0.07285800","lowPrice":"0.06900000","volume":"19985.33300000","openTime":1503128802623,"closeTime":1503215202623,"fristId":466817,"lastId":484582,"count":17766}');
            });
        ...
        it('should make ticker price requests and handle the response', () => {
            mockRequest.setHandler('api/v3/ticker/price', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"symbol":"ETHBTC","price":"0.07597600"}');
            });
        ...
        it('should make book ticker requests and handle the response', () => {
            mockRequest.setHandler('api/v3/ticker/bookTicker', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"symbol":"ETHBTC","bidPrice":"0.07601600","bidQty":"11.71000000","askPrice":"0.07607900","askQty":"3.67800000"}');
            });
    ...
    describe('private, signed API', () => {
        ...
        it('should make new order requests and handle the response', () => {
            mockRequest.setHandler('api/v3/order', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"symbol":"BNBBTC","orderId":1497927,"clientOrderId":"dxkJuIgVohXkBsnI2Crnee","transactTime":1503258363847}');
            });
        ...
        it('should make query order requests and handle the response', () => {
            mockRequest.setHandler('api/v3/order', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"symbol":"BNBBTC","orderId":1497927,"clientOrderId":"dxkJuIgVohXkBsnI2Crnee","price":"0.00063500","origQty":"5.00000000","executedQty":"5.00000000","status":"FILLED","timeInForce":"GTC","type":"LIMIT","side":"SELL","stopPrice":"0.00000000","icebergQty":"0.00000000","time":1503257997234}');
            });
        ...
        it('should make open orders requests and handle the response', () => {
            mockRequest.setHandler('api/v3/openOrders', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"symbol":"BNBBTC","orderId":1500955,"clientOrderId":"z7z7gslJeO4DCDgYe9LtgB","price":"0.00070000","origQty":"5.00000000","executedQty":"0.00000000","status":"NEW","timeInForce":"GTC","type":"LIMIT","side":"SELL","stopPrice":"0.00000000","icebergQty":"0.00000000","time":1503260089565}]');
            });
        ...
        it('should make cancel order requests and handle the response', () => {
            mockRequest.setHandler('api/v3/order', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"symbol":"BNBBTC","origClientOrderId":"z7z7gslJeO4DCDgYe9LtgB","orderId":1500955,"clientOrderId":"jEZRtj2LoKo5Et5VIkNpTk"}');
            });
        ...
        it('should make all order requests and handle the response', () => {
            mockRequest.setHandler('api/v3/allOrders', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"symbol":"BNBBTC","orderId":1500955,"clientOrderId":"z7z7gslJeO4DCDgYe9LtgB","price":"0.00070000","origQty":"5.00000000","executedQty":"0.00000000","status":"CANCELED","timeInForce":"GTC","type":"LIMIT","side":"SELL","stopPrice":"0.00000000","icebergQty":"0.00000000","time":1503260089565}]');
            });
        ...
        it('should make my trades requests and handle the response', () => {
            mockRequest.setHandler('api/v3/myTrades', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '[{"id":345660,"price":"0.00063907","qty":"5.00000000","commission":"0.00000000","commissionAsset":"BNB","time":1503257997234,"isBuyer":false,"isMaker":false,"isBestMatch":true}]');
            });
        ...
        it('should make account status requests and handle the response', () => {
            mockRequest.setHandler('wapi/v3/accountStatus.html', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"msg":"Normal","success":true}');
            });
        ...
        it('should make withdraw requests and handle the response', () => {
            mockRequest.setHandler('wapi/v3/withdraw.html', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"msg": "success","success": true,"id":"7213fea8e94b4a5593d507237e5a555b"}');
            });
        ...
        it('should make deposit history requests and handle the response', () => {
            mockRequest.setHandler('wapi/v3/depositHistory.html', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"depositList": [{"insertTime": 1508198532000,"amount": 0.04670582,"asset": "ETH","address": "0x6915f16f8791d0a1cc2bf47c13a6b2a92000504b","txId": "0xdf33b22bdb2b28b1f75ccd201a4a4m6e7g83jy5fc5d5a9d1340961598cfcb0a1","status": 1}], "success": true}');
            });
        ...
        it('should make withdrawal history requests and handle the response', () => {
            mockRequest.setHandler('wapi/v3/withdrawHistory.html', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"withdrawList": [{"id":"7213fea8e94b4a5593d507237e5a555b","amount": 1,"address": "0x6915f16f8791d0a1cc2bf47c13a6b2a92000504b","asset": "ETH","txId": "0xdf33b22bdb2b28b1f75ccd201a4a4m6e7g83jy5fc5d5a9d1340961598cfcb0a1","applyTime": 1508198532000,"status": 4}],"success": true}');
            });
        ...
        it('should make deposit address requests and handle the response', () => {
            mockRequest.setHandler('wapi/v3/depositAddress.html', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"address": "0x6915f16f8791d0a1cc2bf47c13a6b2a92000504b","success": true,"addressTag": "1231212","asset": "BNB"}');
            });
    ...
    describe('websocket related API', () => {
        ...
        it('should make requests to start a user data stream and handle the response', () => {
            mockRequest.setHandler('api/v1/userDataStream', (options, callback) => {
                ...
                callback(null, { statusCode: 200 }, '{"listenKey":"DdfvqZ427zcWvtOzBSxmchhHPKV1t0lVCHdztRjIdU7CygJckPIIYmx5TOqU"}');
            });
            return binance.startUserDataStream()
                .then((response) => {
                    expect(response).to.deep.equal({ listenKey: 'DdfvqZ427zcWvtOzBSxmchhHPKV1t0lVCHdztRjIdU7CygJckPIIYmx5TOqU' });
                });
        });
        ...
        it('should make requests to keep a user data stream alive and handle the response', () => {
            ...
            return binance.keepAliveUserDataStream({ listenKey: 'DdfvqZ427zcWvtOzBSxmchhHPKV1t0lVCHdztRjIdU7CygJckPIIYmx5TOqU' })
                .then((response) => {
                    expect(response).to.be.an('object').that.is.empty;
                });
        });
        ...
        it('should make requests to close a user data stream and handle the response', () => {
            ...
            return binance.closeUserDataStream({ listenKey: 'DdfvqZ427zcWvtOzBSxmchhHPKV1t0lVCHdztRjIdU7CygJckPIIYmx5TOqU' })
                .then((response) => {
                    expect(response).to.be.an('object').that.is.empty;
                });
        });
